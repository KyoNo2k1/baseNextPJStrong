...
export default function PointManageIcon({ ...rest }: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox='0 0 24 24' width={20} height={20} fill='none' xmlns='http://www.w3.org/2000/svg' {...rest}>
      ...
      <path
        ...
        strokeLinejoin='round'
      />
      <path d='M12 22V7' stroke='#21272A' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
      <path
